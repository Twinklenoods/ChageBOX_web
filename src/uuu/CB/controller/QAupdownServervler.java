 ...
 */
@WebServlet("/member/myproduct/QAupdown.do")
public class QAupdownServervler extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public  QAupdownServervler() {
        super();
		...
		if(errors.isEmpty()) {
			...
			try {
				...
				RequestDispatcher dispatcher = 
						request.getRequestDispatcher("QAdown.jsp");
