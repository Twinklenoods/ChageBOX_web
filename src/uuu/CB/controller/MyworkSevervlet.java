...
/**
 * Servlet implementation class MyworkSevervlet
 */
@WebServlet("/mywork.do")
public class MyworkSevervlet extends HttpServlet {
  ...
  */
  ...
  //1.讀取資料
  String id= request.getParameter("id");//以存在
  
  String name=request.getParameter("name");//以存在
  String birthday=request.getParameter("birthday");//以存在
  String email=request.getParameter("email");
  String address=request.getParameter("address");
  String phone=request.getParameter("phone");
  String gender=request.getParameter("gender");//以存在
