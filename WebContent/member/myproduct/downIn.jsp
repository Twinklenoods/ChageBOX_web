			...
			<nav class="n02"><form autocomplete="off" method="post" action="Product.do">
     			<article class="article-1"><br>
        			...
        			<label for="comment1"></label><br>
       				<textarea id="comment1" name="comment1" placeholder="商品敘述 最多100個字" maxlength="100"style="width: 300px;height: 200px;"><%= product.getDescription() %></textarea><br>
     				<span style="color:red">*</span>
					...
					<div class="ap_item_title f14"><span style="color:red">*</span>直購資料（願意買賣才需要填寫）</div>
  					...
  					<div id="Schange" ><br>想交換物品<br><textarea  required="required" name="WantChange" id="WantChange" rows="5" cols="50" class="ap_area_w500_h80" placeholder="想交換的遊戲 最多100個字" maxlength="100"><%=product.getWantChange()%></textarea><br></div>
  					...
  					<input class="owner" type="text" name="productId" value="<%=product.getId()%>">
