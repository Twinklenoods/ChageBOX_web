		...
		<%Customer member=(Customer)session.getAttribute("member");%>
			...
			<div>
				...
				<div class='dataDiv'>
					...
					<iframe src="https://chart.googleapis.com/chart?chs=120x120&cht=qr&chl=<%= java.net.InetAddress.getLocalHost().getHostAddress()%>:8080<%=request.getContextPath()%>/buyIn.jsp?buyInId=<%= product.getId() %>&choe=UTF-8" name="a"  target="a"style="width:125px;height: 125px;margin-top: 100px;background-color:rgba(250, 50, 50, 0.6);"></iframe>
